...
def convert_single_state(game_state):
    ...
    blinky[state_ghost_positions[0][0], state_ghost_positions[0][1]] = 1

    # Pink Ghost
    pinky = np.zeros((PLANE_WIDTH, PLANE_HEIGHT))
    pinky[state_ghost_positions[1][0], state_ghost_positions[1][1]] = 1

    # Blue Ghost
    inky = np.zeros((PLANE_WIDTH, PLANE_HEIGHT))
    inky[state_ghost_positions[2][0], state_ghost_positions[2][1]] = 1

    # Orange Ghost
    inky = np.zeros((PLANE_WIDTH, PLANE_HEIGHT))
    inky[state_ghost_positions[3][0], state_ghost_positions[3][1]] = 1
...
def convert_state_to_input(game_state, last_input):
    ...
    result[0] = convert_single_state(game_state)
